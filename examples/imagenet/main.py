...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print("Warmup")
    train_dataset_fake = datasets.FakeData(128, (3, 224, 224), 10, transforms.ToTensor())

    train_loader_fake = torch.utils.data.DataLoader(
        train_dataset_fake, batch_size=args.batch_size, shuffle=(train_sampler is None),
        num_workers=args.workers, pin_memory=True, sampler=train_sampler)

    train(train_loader_fake, model, criterion, optimizer, 1, device, args)
