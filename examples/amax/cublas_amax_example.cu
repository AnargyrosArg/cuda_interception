...
int main(int argc, char *argv[]) {
    ...
    fprintf(stderr,"===== cublasSetStream() =====\n");
    ...
    fprintf(stderr,"===== cudaMemcpyAsync() =====\n");
    ...
    /* step 3: compute */
    fprintf(stderr,"===== cublasIdamax() =====\n");
    CUBLAS_CHECK(cublasIdamax(cublasH, A.size(), d_A, incx, &result));
    fprintf(stderr,"==========================\n");

    fprintf(stderr,"===== cudaStreamSynchronize() =====\n");
